...
function wrapperProperty(target, descriptor, options = {}) {
    console.warn("Deprecated， Starting from version 4.0, the wrapperProperty method will be deprecated and no longer recommended");
...
function wrapperAll(target, options) {
    console.warn("Deprecated， Starting from version 4.0, the wrapperAll method will be deprecated and no longer recommended");
...
function requests(method, pathStr, formatter) {
    console.warn("Deprecated， Starting from version 4.0, the requests method will be deprecated and no longer recommended");
