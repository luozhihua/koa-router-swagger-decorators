...
const async_emitter_1 = __importDefault(require("./utils/async-emitter"));
...
function createRouter(options) {
    ...
    lodash_merge_1.default(true, config_1.config, options);
...
function wrapperProperty(target, descriptor, options = {}) {
    ...
    target.decoratorEmitter = target.decoratorEmitter || new async_emitter_1.default();
